...
const ErrorFragmentFragmentDoc = main_cjs.gql`
    fragment ErrorFragment on FieldError {
  field
  message
}
    `;
const UserFragmentFragmentDoc = main_cjs.gql`
    fragment UserFragment on User {
  id
  username
}
    `;
const RegistrationFragmentFragmentDoc = main_cjs.gql`
...
const RegisterDocument = main_cjs.gql`
...
function useMeQuery(baseOptions) {
  ...
  return main_cjs.useQuery(MeDocument, options);
}
...
;// CONCATENATED MODULE: ./src/ui/utils/ProtectedRoute.tsx
...
/* harmony default export */ var utils_ProtectedRoute = (ProtectedRoute);
...
const Home = () => {
  return /*#__PURE__*/jsx_runtime.jsx(utils_ProtectedRoute, {
...
/* harmony default export */ var pages = ((0,withApollo/* withApollo */.C)({
  ssr: true
})(Home));
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(57194);
      ...
      const compMod = __webpack_require__(19022)
      ...
      const { renderReqToHTML, render } = (0,next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__/* .getPageHandler */ .u)({
        ...
        i18n: undefined,
        page: "/",
        buildId: "f4wP4iFJ1bs3t8WIcoU32",
        escapedBuildId: "f4wP4iFJ1bs3t8WIcoU32",
        basePath: "",
        pageIsDynamic: false,
        encodedPreviewProps: {previewModeId:"742e1f64b2cda3a02b03ad2356c6b66b",previewModeSigningKey:"2abf8ccb90c9f3466232c52e2c37942720d9931eb7cc3fe2cd0a8f6e69fc8c02",previewModeEncryptionKey:"548e8115756a1f46fc6894a96ab0fb88f394274defc45052dd07cccab9a74d15"}
      })
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [749,281,632,251,102,799,765], function() { return __webpack_require__(82811); })
